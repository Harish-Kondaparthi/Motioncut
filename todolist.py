...
class TaskListApp:
    def __init__(self, root):
        ...
        self.desc_entry.grid(row=0, column=1, sticky=(tk.W, tk.E))

        ttk.Label(entry_frame, text="Due Date:").grid(row=1, column=0, sticky=tk.W)
        self.date_entry = ttk.Entry(entry_frame, width=20)
        self.date_entry.grid(row=1, column=1, sticky=(tk.W, tk.E))
